...
/*	if(iCurrentCourseID == '1130')
	...
	*/
	...
	{		
		...
		{			
			if((PreReqForCourse[i].SRC_COURSE == SelectedCourseIDs[j]) && (GetScoreValue(school_id,SelectedCourseScores[j]) >= GetScoreValue(school_id,PreReqForCourse[i].REQ_SCORE)))
			{
